create FUNCTION terbilang_angka(masukan IN NUMBER)
    RETURN
        VARCHAR2 IS
    -- Setting Parameter
...
BEGIN
    ...
    END IF;
    bilangan := TO_CHAR(temp_masukan, '999999999999990.000');
    /*                                 2345678901234567890
      Format to_char di atas jangan dirubah
          234 = Trilyun        11 .. 13 = Ribu
          567 = Milyar         14 .. 16 = Satuan
          8..10 = Juta         18 .. 20 = Pecahan    */
...
--------------------------------------------------------------------
    ...
    hasil_akhir := kata_kata_awal || RTRIM(hasil_akhir) || kata_kata_akhir;
